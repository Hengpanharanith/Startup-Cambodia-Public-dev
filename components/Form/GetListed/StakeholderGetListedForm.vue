  ...
  >
    <v-card>
      <v-toolbar
        ...
        flat
      >
        <v-card-title> {{ $t("get_listed.othere.title") }}</v-card-title>
        <v-spacer></v-spacer>
        <v-btn
          right
          icon
        ...
        >
          <v-stepper-header>
            <v-stepper-step
              ...
              step="1"
            >
              {{ $t("get_listed.other.stepper.header.basic_info") }}
            </v-stepper-step>
            <v-divider></v-divider>

            <v-stepper-step step="2">
              {{ $t("get_listed.other.stepper.header.verify_info") }}
            </v-stepper-step>
          </v-stepper-header>
        </v-stepper>
      </v-card-actions>
            ...
            <v-form ref="form">
              <v-stepper-items>
                  ...
                  <v-row>
                    ...
                    >
                      <v-autocomplete
                        dense
                        outlined
                        :label="$t('get_listed.form.label.stakeholder_type')"
                        class="input-group--focused"
                        :items="stakeholder_type"
                        item-text="name"
                        item-value="id"
                        v-model="editedItem.stakeholder_type"
                ...
                <v-stepper-content step="2">
                  ...
                  <v-row v-if="editedItem.stakeholder_type">
                    <v-col cols="4">{{
                      $t("get_listed.form.label.stakeholder_type")
                    }}</v-col>
                    <v-col cols="8">{{
                      getStakeholderById(editedItem.stakeholder_type)
                    }}</v-col>
                  </v-row>
